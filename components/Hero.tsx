    ...
    <section className="mx-auto max-w-shell px-4 pt-8 sm:px-6 lg:px-8">
      <div className="grid items-center gap-10 rounded-2xl border border-hairline bg-surface px-6 py-12 sm:px-10 lg:grid-cols-2 lg:px-14 lg:py-16">
        <div>
          ...
          <a
            href="#library"
            className="mt-8 inline-flex items-center rounded-full bg-accent px-6 py-3 font-display text-sm font-semibold uppercase tracking-wider text-ink transition hover:bg-accent-dim"
          >
            Browse Workouts
          </a>
        </div>
